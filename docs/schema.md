...
| **개인 정보** | Relation | Link to the *Private Info* database (1:1). |
| **임원** | MultiSelect | Roles like "25-2 회 장" for identifying officers. |
| **활동 기록** | Relation | Link to the *Activities* database (Multiple). |
...
| **회원 정보** | Relation | Link back to the *Members* database. |
...
| **출석** | Relation | Link to *Members* database (Attendees). |
...
| **진행자** | Relation | Link to *Members* database (Speakers). |
