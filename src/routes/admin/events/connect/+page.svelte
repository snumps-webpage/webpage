...
<style>
    ...
    h1 { margin: 0 0 0.5rem 0; color: var(--text-primary); }
    ...
    .event-card.selected { border-color: #667eea; background: var(--btn-secondary); }
    ...
    .publish:disabled { background: var(--border-color); cursor: not-allowed; }
