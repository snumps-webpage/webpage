...
<article class="paper-document seminar-paper">
    <header class="paper-document-header">
        <h1 class="paper-document-title no-sel">세미나 개설 신청</h1>
        <p class="paper-document-subtitle no-sel">세미나 신청서</p>
    </header>
    ...
    {:else}
        <form method="POST" use:enhance={() => {
            ...
            <ol class="paper-sections">
                ...
                <li class="paper-section">
                    <h2 class="paper-section-title">발표자 설정</h2>
                    <div class="field">
                        <div class="label-row">
                ...
                <li class="paper-section">
                    <h2 class="paper-section-title">포스터 자동 만들기 (선택)</h2>
                    <details class="poster-helper" bind:open={posterHelperOpen}>
                        <summary class="poster-helper-summary no-sel">
                            {posterHelperOpen ? '접기' : '펼쳐서 포스터 만들기'}
                        </summary>
                        <div class="poster-helper-content">
                            <p class="hint no-sel poster-helper-intro">
                                포스터를 따로 제작하기 번거로운 분들을 위해, 입력한 내용으로 바로 포스터를 만들고 다운로드할 수 있습니다.
                            </p>
                            ...
                            <div class="field">
                                ...
                                />
                                <p class="hint no-sel">비워두면 “추후 공지”로 표시됩니다.</p>
                            </div>
...
<style>
    ...
    .poster-helper-summary::-webkit-details-marker {
        display: none;
    }

    .poster-helper[open] .poster-helper-summary {
        border-bottom: 1px solid var(--latex-rule);
        background: color-mix(in srgb, var(--latex-text) 4%, var(--latex-bg));
    }

    .poster-helper-content {
